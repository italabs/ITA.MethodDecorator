    ...
    public static class IlHelper {
        public static IEnumerable<Instruction> ProcessParam(ParameterDefinition parameterDefinition, VariableDefinition paramsArray) {
            ...
            if (paramType.IsByReference) {
                ...
                var optionalModifierType = (OptionalModifierType)paramType;
                if (optionalModifierType.ElementType.IsValueType) {
                    // Box the parameter type
                    yield return Instruction.Create(OpCodes.Box, optionalModifierType.ElementType);
                }
            }
            else {
